...
public class ConstituencyAutoCompleteAdapter extends ArrayAdapter<LocationModel> {
    String variant;
    ...
    public ConstituencyAutoCompleteAdapter(Context context, int textViewResourceId, List<LocationModel> locationModels, String variant) {
