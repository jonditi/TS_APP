...
public class Urls {
    ...
    public static String UPLOAD_CONSTITUENCY_IMAGE = baseUrl + "constituency_uploads.php";
    public static String PUSH_CONSTITUENCY_TALLY = baseUrl + "push_constituency_tallying.php";
