...
public class WardAutoCompleteAdapter extends ArrayAdapter<LocationModel> {
    ...
    public WardAutoCompleteAdapter(Context context, int textViewResourceId, List<LocationModel> locationModels, String variant) {
